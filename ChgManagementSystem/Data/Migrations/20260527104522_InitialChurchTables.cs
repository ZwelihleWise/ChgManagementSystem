...
{
    /// <inheritdoc />
    public partial class InitialChurchTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_Circuits_CircuitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TitheRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TitheRecords_Members_MemberId",
                        column: x => x.MemberId,
